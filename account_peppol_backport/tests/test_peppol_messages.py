...
class TestPeppolMessage(RequestHandlerTransactionCase):
    ...
    def _request_handler(cls, s: Session, r: PreparedRequest, /, **kw):
        ...
        if r.url.endswith(
            "iso6523-actorid-upis%3A%3A0208%3A0477472701"
        ) or r.url.endswith("iso6523-actorid-upis%3A%3A9925%3ABE0477472701"):
            ...
            return response
        if r.url.endswith(
            "iso6523-actorid-upis%3A%3A0208%3A3141592654"
        ) or r.url.endswith("iso6523-actorid-upis%3A%3A9925%3ABE3141592654"):
