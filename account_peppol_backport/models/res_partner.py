    ...
    def button_account_peppol_check_partner_endpoint(self):
        ...
        if not (self.peppol_eas and self.peppol_endpoint) or not self.is_peppol_edi_format:
            ...
            if (
                ...
                inverse_endpoint = f'BE{self.peppol_endpoint}' if self.peppol_eas == '0208' else self.peppol_endpoint[
                    2:]
                if self._check_peppol_participant_exists(f'{inverse_eas}:{inverse_endpoint}',
