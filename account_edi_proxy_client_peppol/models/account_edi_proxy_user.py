...
class AccountEdiProxyClientPeppolUser(models.Model):
    ...
    _sql_constraints = [
        ...
        ('uniq_active_edi_identif', '', 'This edi identification is already assigned to an active user'),
        ('uniq_active_company_proxy', '', 'This company has an active user already created for this EDI type'),
    ]
